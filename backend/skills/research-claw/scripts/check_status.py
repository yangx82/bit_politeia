...
def check_status(task_id: str):
    ...
    if summary_path.exists():
        try:
            ...
            task_manager.complete_task(task_id, lessons=f"Research completed successfully. Final stage: {status_info['stage']}")
        except:
            pass
        ...
        try:
            ...
            task_manager.update_task_checkpoint(task_id, f"Stage {status_info['stage']}: {status_info['stage_name']} ({status_info['progress']})")
        except:
            pass

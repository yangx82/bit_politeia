...
async def run_test():
    ...
    await asyncio.gather(
        manager_a.initiate_connection("node_b"),
        manager_b.initiate_connection("node_a")
    )
    ...
    for _ in range(30):
        ...
        a_open = "node_b" in manager_a.data_channels and manager_a.data_channels["node_b"].readyState == "open"
        b_open = "node_a" in manager_b.data_channels and manager_b.data_channels["node_a"].readyState == "open"

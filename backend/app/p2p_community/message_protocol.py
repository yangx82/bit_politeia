...
class MessageProtocol:
    ...
    def create_gossip_message(
        ...
        return self.create_message(
            sender_id, recipient_id, MessageType.GOSSIP, content
        )
    ...
    def create_group_broadcast(
        ...
        return self.create_message(
            sender_id, group_id, MessageType.GROUP, content
        )
    ...
    def create_sync_message(
        ...
        return self.create_message(
            sender_id, recipient_id, MessageType.SYNC, content
        )
    ...
    def create_proposal_message(
        ...
        return self.create_message(
            sender_id, group_id, MessageType.PROPOSAL, content
        )
    ...
    def create_vote_message(
        ...
        return self.create_message(
            sender_id, group_id, MessageType.VOTE, content
        )

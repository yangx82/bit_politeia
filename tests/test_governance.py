...
def test_election_lifecycle(governance_manager):
    ...
    governance_manager.receive_ballot(
        election.election_id, [Vote("voter1", "cand1", approval=True)]
    )
    governance_manager.receive_ballot(
        election.election_id, [Vote("voter2", "cand1", approval=True)]
    )
    governance_manager.receive_ballot(
        election.election_id, [Vote("voter3", "cand1", approval=True)]
    )
    governance_manager.receive_ballot(
        election.election_id, [Vote("voter4", "cand2", approval=True)]
    )
    governance_manager.receive_ballot(
        election.election_id, [Vote("voter5", "cand2", approval=True)]
    )
...
def test_ballot_validation(governance_manager):
    ...
    invalid_ballot = [Vote("v1", "cand1", approval=True), Vote("v1", "cand2", approval=True)]
    ...
    valid_ballot = [Vote("v1", "cand1", approval=True), Vote("v1", "cand2", approval=False)]

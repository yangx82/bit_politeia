...
from app.p2p_community.message_protocol import MessageType, SignedMessage
...
async def run_test():
    ...
    with patch('app.services.agent_service.agent_service.governance_manager', mock_gov_manager):
        ...
        with patch.object(p2p_service, '_forward_governance_message', return_value=None) as mock_forward:
            ...
            try:
                mock_gov_manager.receive_p2p_event.assert_called_once_with("election", election_data)

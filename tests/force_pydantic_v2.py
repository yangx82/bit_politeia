...
if "pydantic.v1" in new_content:
    new_content = new_content.replace("from pydantic.v1 import BaseSettings", "from pydantic_settings import BaseSettings")
    new_content = new_content.replace("from pydantic.v1 import validator", "# from pydantic.v1 import validator")
